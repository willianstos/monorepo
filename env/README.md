...
- `bootstrap/github-mirror-auth.sh` performs the one-time GitHub mirror registration from local token state and configures `gh` + Git credential helper for later `/git` runs.
